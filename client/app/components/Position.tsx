...
export const Position = () => {
    ...
    return (
        <div className="inline mt-5 w-11/12 m-auto overflow-auto pb-16">
            <div className="flex flex-wrap h-full overflow-auto">
                <div className="text-white border-solid border-2 border-white p-3 rounded-xl m-10 w-64 cursor-pointer" onClick={toggleTable}>
